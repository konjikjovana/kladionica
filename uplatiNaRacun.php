...
$korisnici = $baza->vratiKorisnikeKockare();
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <select class="form-control" id="korisnik">
                        ...
                        foreach ($korisnici as $kor){
                            ?>
                        <option value="<?= $kor->korisnikID ?>"><?= $kor->imePrezime ?></option>
                        <?php
                        }
                        ?>
                    </select>
                ...
                <div class="col-12">
                    ...
                    <input type="number" id="uplata" class="form-control" placeholder="Iznos uplate" >
                </div>
                <hr>
                <div class="col-12">
                    <button class="btn-dark btn-lg btn" id="dugme" onclick="uplatiNaRacun()">Uplata na racun</button>
                </div>
                <div class="col-12">
                    <p id="Iznos"></p>
...
<script>
    ...
    function uplatiNaRacun() {
        let korisnikID = $("#korisnik").val();
